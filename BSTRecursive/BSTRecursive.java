...
public class BSTRecursive {
	...
	public int numNodesLessThan(BSTNode n,int v) {
		...
		if(n.data < v) {
			return 1 + numNodesLessThan(n.right, v) + numNodesLessThan(n.left, v);
		}
		return numNodesLessThan(n.right, v) + numNodesLessThan(n.left, v);
	}
	...
	public int numLeavesLessThan(BSTNode n, int v) {
		if(n == null) return 0;
		if(n.data < v && n.right == null && n.left == null) {
			return 1;
		}
		return numLeavesLessThan(n.right, v) + numLeavesLessThan(n.left, v);
	}
	...
	public int nextOf(BSTNode n,int v){
		if(n == null) return v;
		if(n.data > v) {
			if(nextOf(n.left, v) == v) return n.data;
